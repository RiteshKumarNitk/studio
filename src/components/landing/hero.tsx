  ...
  return (
    ...
    >
      ...
      <Image
        ...
        fill
        className="object-cover object-bottom -z-20 hidden md:block"
      />

      {/* Mobile Image */}
      <Image
        src="/testimonial/Slider_2_mobile.jpg"
        alt="Car being washed (Mobile)"
        fill
        className="object-cover object-center -z-20 md:hidden"
      />
